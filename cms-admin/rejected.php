    ...
    <div class="card-body">
      ...
      <form class="pt-3" id="pendingComplaint">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control form-control-lg bg-danger text-light" id="status" name="status" placeholder="status" readonly>
        </div>
        <div class="form-group">
...
<!--  -->
  ...
  <script>
    ...
    window.addEventListener("load", () => {
      ...
      form.append("button", "viewRejected");
