...
<body>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-inverse-secondary card-outline-secondary">
                    <div class="card-body">
                    <a class="mb-4 col-md-9 card card-inverse-secondary" href="requested.php">Total Requests</a>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-inverse-warning card-outline-warning">
                    <div class="card-body">
                      <a class="mb-4 col-md-9 card card-inverse-warning" href="pending.php">Total Pending</a>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-inverse-success card-outline-success">
                    <div class="card-body">
                    <a class="mb-4 col-md-9 card card-inverse-success" href="fulfilled.php">Total Fulfiled</a>
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-inverse-danger card-outline-danger">
                    <div class="card-body">
                    <a class="mb-4 col-md-9 card card-inverse-danger" href="rejected.php">Total Rejected</a>
  ...
  <script>
    ...
    window.addEventListener("load", () => {
      ...
      fetch("control_Admin.php", {
        ...
        if (data == "empty") {
          ...
          const mappedData = data.map(obj => `
            ...
            <img src="../CMS/${obj.image}" alt="image">
      ...
      // form.append("email", hiddenEmail.value);
      form2.append("button", "totalNumbers",);
      fetch("control_Admin.php", {
        method: "POST",
        body: form2
      }).then(resp => resp.json()).then(data => {
