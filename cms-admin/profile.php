...
<body>
  ...
  <script>
    // Copy of register.php
    // in db if 1 or more fields are empty then don't update them(if else)
    // On page load fetch the user data and fill in the corresponding fields
