...
<body>
        ...
        <div class="content-wrapper">
          ...
          <div class="row hidden" id="viewFormCont">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> All pending Complaints</h4>
                  <p class="card-description">
                    Displaying all pending complaints
                  </p>
                  <form class="pt-3" id="pendingComplaint">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control form-control-lg" id="email" name="email" placeholder="Email" value="<?php echo $_SESSION['email']; ?>" readonly>
                    </div>
                    <!-- Complaint id -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-lg text-light bg-success" id="status" name="status" placeholder="status" readonly>
                    </div>
                    <div class="form-group">
  ...
  <script>
    ...
    window.addEventListener("load", () => {
      ...
      form.append("button", "viewFulfilled");
