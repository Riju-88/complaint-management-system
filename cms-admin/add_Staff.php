...
<body>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Fill all the details about the staff
                  </p>
                  <form class="pt-3" id="staffForm">
                    <!-- Complaint subject -->
                    ...
                    <div class="mt-3">
                      <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" id="add">Add Staff</a>
                    </div>
  ...
  <script>
    ...
    let form = document.querySelector("#staffForm");
    ...
    add.addEventListener("click", (e) => {
      ...
      fetch("control_Admin.php", {
        ...
        if (response == "success") {
          ...
          addStatus.innerHTML = `<label class="badge badge-success">Staff has been added Successfully!</label>`;
        } else if (response == "failed") {
          addStatus.innerHTML = `<label class="badge badge-danger">Couldn't add Staff</label>`;
        } else {
