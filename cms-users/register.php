...
<body>
  ...
  <script>
    ...
    register.addEventListener("click", (e) => {
      ...
      // regex to check pass
      if (/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@$!%*#?&.])[A-Za-z\d@$!%*#?&.]{8,}$/.test(pass.value)==false) {
        console.log(pass.value);
        regStatus.innerHTML = `<label class="text-danger"><p>Password must be 8 or more characters and must contain symbols,numbers,uppercase and lowercase characters</p></label>`;
      } else {
        console.log(pass.value);
